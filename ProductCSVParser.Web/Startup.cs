using AutoMapper;
using ProductCSVParser.Business;
...
using ProductCSVParser.Web.Mappings;

namespace ProductCSVParser.Web
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            // Add AutoMapper profile mappings
            services.AddAutoMapper(typeof(CsvProductMapping), typeof(RetailerProductMapping), typeof(ProductMapping));
